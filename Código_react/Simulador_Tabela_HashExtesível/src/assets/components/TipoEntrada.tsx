    ...
    <div className="flex space-x-4">
      <div className="flex items-center">
        <input
          ...
          checked={props.content === 'number'}
            onChange={() => {props.set('number'); props.sethashTable(new HashExtensivel<ElementoNumber>(props.tamanho, props.referenciaCanvas)); props.update((u:boolean)=> !u)}}
          className="hidden"
        />
      ...
      <div className="flex items-center">
        <input
          ...
          onChange={() => {props.set('text'); props.sethashTable(new HashExtensivel<ElementoChar>(props.tamanho, props.referenciaCanvas));  props.update((u:boolean)=> !u)}}
          className="hidden"
        />
